...
Route::get('/scrum/home', '\App\Http\Controllers\scrum\DashboardController@index')->name('scrum.home');
...
//Route to view blank Forum page
Route::get('/forum/{project}', 'ForumController@index')->name('forum.index');
//Route to insert new Forum page
Route::get('/forum/{project}/create', 'ForumController@create')->name('forum.create');
//Route to store details of new Forum page
Route::post('/forum/{project}', 'ForumController@store')->name('forum.store');
// Route to forum list
Route::get('/forum/{project}', 'ForumController@viewList')->name('forum.index');
//Route to edit Forum page
Route::get('/forum/{project}/{id}/edit', 'ForumController@edit')->name('forum.edit');
// Route to forum detail
Route::get('/forum/{project}/{id}/detail', 'ForumController@dispDetail')->name('forum.detail');
//Route to store comment for Forum
Route::post('/forum/{project}/-', 'ForumController@storeComment')->name('forum.storeComment');
// Route to search forum
Route::get('/forum/{project}/search', 'ForumController@search')->name('forum.search');
//Route to update Forum page
Route::post('/forum/{project}/{id}/update', 'ForumController@update')->name('forum.update');

//Route for delete Mapping
Route::post('mapping/destroy', 'MappingController@destroy')->name('mapping.destroy');

//Route to view blank Defect page
Route::get('/defect/{project}', 'DefectController@index')->name('defect.index');
// Route to defect list
Route::get('/defect/{project}', 'DefectController@viewList')->name('defect.index');
//Route to insert new Defect page
Route::get('/defect/{project}/create', 'DefectController@create')->name('defect.create');
//Route to store details of new Defect page
Route::post('/defect/{project}', 'DefectController@store')->name('defect.store');
// Route to delete defect
Route::get('/defect/{project}/{id}/delete', 'DefectController@delete')->name('defect.delete');
// Route to search defect
Route::get('/defect/{project}/search', 'DefectController@search')->name('defect.search');
//Route to edit defect
Route::get('/defect/{project}/{id}/edit', 'DefectController@edit')->name('defect.edit');
//Route to update defect
Route::post('/defect/{project}/{id}/update', 'DefectController@update')->name('defect.update');

//Route to view Task page
Route::get('/task2/{project}', 'Task2Controller@index')->name('task2.index');
// Route to task list
Route::get('/task2/{project}', 'Task2Controller@viewList')->name('task2.index');
//Route to store new task
Route::post('/task2/{project}', 'Task2Controller@storeTask')->name('task2.storeTask');
// Route to update task status
Route::post('/task2/{project}/{task2}/update', 'Task2Controller@updateStatus')->name('task2.updateStatus');
// Route to delete task
Route::get('/task2/{project}/{task2}/delete', 'Task2Controller@delete')->name('task2.delete');
